...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 03 déc. 2022 à 23:28
...
(1, 18, 1, 'Cannabis', 'Le cannabis (parfois appelé la « marijuana ») est une drogue qui est le produit de la plante de cannabis. Selon la façon qu\'il est préparé, le cannabis peut être consommé à des fins médicales ou non médicales (« récréatives »).', 8.7, 'cannabis.png', '2022-12-02 20:20:59', '2022-12-02 20:20:59', 227, 'Mexique', 1),
(2, 18, 2, 'MDMA', 'Drogue de synthèse dérivée de la méthamphétamine, aussi connue sous le nom d\'ecstasy.', 14.99, 'mdma.png', '2022-12-02 20:20:59', '2022-12-02 20:20:59', 86, 'France', 1),
...
(4, 18, 2, 'LSD', 'SD signifie acide lysergique diéthylamide. Il cause des hallucinations et il a des effets très imprévisibles. Sous sa forme la pure, le LSD a l\'aspect d\'une poudre cristalline blanche, inodore et au goût légèrement amer.', 12.33, 'lsd.jpg', '2022-12-02 20:20:59', '2022-12-02 20:20:59', 666, 'Etats-Unis', 1),
(5, 16, 2, 'Champignons hallucinogènes', 'Les champignons hallucinogènes, champis, champignons magiques, ou encore magic mushrooms, sont des champignons possédant des propriétés hallucinogènes et enthéogènes dues à diverses molécules en fonction de leur espèce. Leur mode d\'administration majoritaire est la voie orale, une petite minorité se fumant.', 37.66, 'champignons.png', '2022-12-02 20:20:59', '2022-12-02 20:20:59', 32, 'Argentine', 1),
...
(8, 16, 3, 'Anadrol', 'L\'oxymétholone (Anadrol), est un puissant stéroïde anabolisant et androgène. Son nom chimique est : 17(béta)-hydroxy-2-(hydroxyméthylène)-17-méthyl-5(alpha)-androstan-3-one.', 69.99, 'anadrol.png', '2022-12-03 23:06:24', '2022-12-03 23:06:24', 24, 'Etats-Unis', 1),
(9, 16, 3, 'Dianabol', 'Le méthandrosténolone (Danabol, Dianabol, DBOL) est un stéroïde anabolisant, développé par John Ziegler et commercialisé par le laboratoire pharmaceutique Ciba en 1958. Il était employé par les pratiquants de bodybuilding jusqu\'à son interdiction dans de nombreux pays et par de nombreux organismes.', 37.9, 'dianabol.png', '2022-12-03 23:06:24', '2022-12-03 23:06:24', 41, 'France', 1);
...
(12, '$2y$13$D3ni2r7Z0Lh0YrG.BPwUd.bFk4L8Sm2ukz8QQOUZqkCJWsRJoMVjW', 'aaa@aaa.aaa', '[]', 'aaa', 'aaa'),
(13, '$2y$13$qnlA8U4YVXBd45jh2YEOruvgMRG4XWy5ldMbSX36y/qZIdJDQfUea', 'aze', '[]', 'aze', 'aze'),
(14, '$2y$13$P1nFDlq5BAAbBSZkRJuTB.ZT0aLaG/6xvuzCaDor0JJdfldHUyUwW', 'acheter@acheter.com', '[]', 'acheter', 'acheter'),
(16, '$2y$13$EtK8djDoCOdNKLvBMZ7sduoKB9BKKJkIc6DVYUz9IdFc2atB5Q/mq', 'vendeur@vendeur.com', '[\"ROLE_SELLER\"]', 'vendeur', 'vendeur'),
(17, '$2y$13$z7xoCUpRRX.ewa/IN7KF7ORQe39hbsPl9u/e7o6m3S1j6INcjKwQm', 'admin@admin.com', '[\"ROLE_ADMIN\"]', 'admin', 'admin'),
(18, '$2y$13$0sOUaz7k02D61QYCUW5rAerojWW6r9FwcEOLkpyUvXHIc1mC4PTnu', 'vendeur1@vendeur1.com', '[\"ROLE_SELLER\"]', 'vendeur1', 'vendeur1');
